...
```mermaid
graph TD
  MOC["写作导航导图 (00-Writing Map)"] --> T["01 写作模板 (Writing Template)"]
  MOC --> S["02 万能句库 (Universal Sentences - 8大主题)"]
  MOC --> E["03 范文精选 (Model Essays - 19篇)"]
  
  T --> |"通用三段式/信件结构"| E
  S --> |"高分论据与亮点句型"| E
  E -.-> |"真题演练沉淀"| M8["09- Examination（试卷）"]
```

---
## 📐 一、写作模板体系（Writing Template）
...
## 💎 二、8 大主题万能句库（Universal Sentences）
